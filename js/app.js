    ...
    "56d7": function(t, e, n) {
        ...
        var i = n("2b0e"),
            ...
            h = function() {
                ...
                return n("div", {
                ...
                }, [t._v("SVX" + t._s(t.$t("i18nView.svxTitle")))]), n("span", {
                    ...
                    staticClass: "mb-2 text-left"
                }, [n("label", {}, [t._v("SOV " + t._s(t.$t("i18nView.balance")) + ": " + t._s(t.sovBalance))])]), n("div", {
                    staticClass: "mb-2 text-left"
                ...
                }, [t._v(t._s(t.$t("i18nView.enableAuto")) + " 210.0000 SOV")])]), n("div", {
            ...
            C = {
                ...
                created: function() {
                    ...
                    this.currentEndpoint = T.protocol + "://" + T.host,
                        ...
                        _.a.scatter.connect("SVXAutoMiner").then(function(e) {
                            if (!e)
                                return !1;
                ...
                methods: {
                    ...
                    queryState: function() {
                        var t = this;
                        this.currentAccount && (this.readOnlyEos.getCurrencyBalance("sovmintofeos", this.currentAccount, "SOV").then(function(e) {
                                t.sovBalance = e[0]
                            }),
                            this.readOnlyEos.getCurrencyBalance("svxmintofeos", this.currentAccount, "SVX").then(function(e) {
                                t.svxBalance = e[0]
                            }),
                    ...
                    queryBalance: function() {
                        var t = this;
                        this.currentAccount && this.readOnlyEos.getCurrencyBalance("svxmintofeos", "svxmintofeos", "SVX").then(function(e) {
                            t.contractAmount = e[0],
                                t.predictAmount = parseFloat(parseFloat(e[0]) / 2e4).toFixed(4) + " SVX"
                        })
                    }
                }
            },
        ...
        var V = new u["a"]({
            ...
            D = {
                i18nView: {
                    ...
                    airgrabTip: "根据 SVX 的空投方式，用户可以将任意金额的 SOV 转账至 sovdexrelays 这个账户，智能合约会将等量的 SOV 返回至用户账户，并会将 svxmintofeos 这个账户中存有的 0.005% SVX 发送到用户账户中",
                    enableAuto: "开启自动转账",
                    stopAuto: "停止自动转账",
                    svxTitle: "空投矿机",
                    error: "错误: ",
                    ...
                    left: "剩余 ",
                    actionsPerTx: "倍速:",
                    actionsPerTxTip: "速度越高，挖掘速度越快，SOV的资源消耗和刻录速度越快，CPU使用效率越高，速度越高，就会导致智能模式出现故障和不稳定等问题。",
                    bpBlocker: "智能模式",
            ...
            Q = {
                i18nView: {
                    ...
                    airgrabTip: "Send any amount of SOV to sovdexrelays, the SOV will instantly be refunded (minus the burn for transfers) and you will mine 0.005% of the SVX balance of svxmintofeos",
                    ...
                    cpuTips: "It will fail when your CPU & NET is exceeds 100%",
                    settingTips: "There will be errors caused by the fluctuation of CPU and timing",
                    advSetting: "Settings",
                    cpuQuota: "CPU Quota ",
                    ...
                    left: "Left",
                    actionsPerTx: "Speed:",
                    actionsPerTxTip: "High speed will burn more SOV / CPU to mine SVX faster",
